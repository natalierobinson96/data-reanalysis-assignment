...
figure1 <- barplot(v, main = "Figure 1", xlab = "female endocrine status", ylab = "mating events observed", names.arg = c("non-periovulatory","non-periovulatory","pregnant","pregnant", "periovulatory", "periovulatory"), col = "black", density = c(100, 0, 100, 0, 100, 0), space = c(1, 0, 1, 0, 1, 0))
```

This is what the original figure from the paper looked like:

<img src="img/Figure 1 pdf.pdf" width="200px"/>
# this is not working
